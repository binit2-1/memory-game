      ...
      <div className='relative z-10 flex flex-col items-center justify-center h-full'>
        <div className='relative rounded-2xl shadow-2xl border-2 border-red-500 text-center overflow-hidden animate-popup' style={{ width: '800px', height: '450px' }}>
          ...
          <div className='relative z-10 flex flex-col items-center justify-center h-full px-8'>
            ...
            <p className='text-lg font-title text-gray-300 mb-4 animate-slide-up animation-delay-100'>You clicked the same card twice</p>
            ...
            <button 
              onClick={onPlayAgain}
              className='px-6 py-3 bg-gradient-to-r from-yellow-400 to-yellow-300 text-black text-lg font-title font-bold rounded-lg hover:from-yellow-300 hover:to-yellow-200 transform hover:scale-105 transition-all duration-200 shadow-lg animate-bounce-in animation-delay-300'
            >
              Play Again
            </button>
          </div>
